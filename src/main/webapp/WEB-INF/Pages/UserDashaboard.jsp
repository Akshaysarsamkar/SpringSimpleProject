...
.header {
	...
	background-image: linear-gradient(to top, rgba(0, 0, 0, 0.8) 0,
		rgba(0, 0, 0, 0) 60%, rgba(0, 0, 0, 0.8) 100%), url("https://wallpapercave.com/wp/wp3631309.jpg");
				...
				<ul class="navbar-nav mr-auto">
					<li class="nav-item dropdown"><a
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							<a class="dropdown-item" href="${pageContext.request.contextPath}/addorder">Add Order</a> <a
								class="dropdown-item" href="${pageContext.request.contextPath }/showorders">See Order</a>
